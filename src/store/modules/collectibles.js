export default {    
    ...
    getters: {
      ...
      getCollectibleHeaderImages(state) {

        // initialize a Set object
        const uniqueValuesSet = new Set();
        const filteredArr = state.collectibles.filter((obj) => {
        ...
        // const titleImages = [];
        // const getTitles = collectionName => titleImages.push(collectionName);
        // filteredArr.forEach(collectible => getTitles(collectible.collectionName));     
        
        // const imgHost = 'http://images.neopets.com/ncmall/collectibles/case/buttons/';
        // const imgType = '.png';
        // const getTitleUrl = title => imgHost + title + imgType;        
        
        // const titleUrls = titleImages.map(getTitleUrl);
